...
function show_trace_entry(io, frame, n; prefix = " in ", withcolor::Bool = false)
    print(io, "\n")
    show(io, frame, full_path=true; prefix = prefix, withcolor = withcolor)
...
function show_backtrace(io::IO, t::Vector)
    ...
    process_entry = (last_frame, n) -> begin
        ...
        show_trace_entry(io, last_frame, n, prefix = string(" "^n_spaces_align, "[", frame_counter, "] "), withcolor = get(io, :hascolor, false))
    end
